...
myrow=7;  %target detector
mycol=19;
ct=ctime;  %or whatever ctime you're actually interested in

%just do a dummy pointing for test purposes.  For real work, put in actual ra/dec targets like:
%ra_targ=125*pi/180;
%dec_targ=-23*pi/180;

az_targ=45*pi/180;
el_targ=66*pi/180;
[ra_targ,dec_targ]=get_radec_from_altaz_actpol_c(az_targ,el_targ,ct);
